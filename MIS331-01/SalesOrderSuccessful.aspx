<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalesOrderSuccessful.aspx.cs" Inherits="MIS331_01.SalesOrderSuccessful" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div style="width:50%; padding-top:150px; padding-bottom:150px; padding-left:150px; padding-right:150px;background-color:#EBEBD3">
            ...
            <div>
                <asp:Label ID="Label1" runat="server" Text="The Sales Order #"></asp:Label>
            </div>
